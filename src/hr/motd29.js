...
var Futsalx4=`
{
	...
	"bg" : { "type" : "", "color" : "464646", "width" : 700, "height" : 320, "kickOffRadius" : 80, "cornerRadius" : 0 },
	...
	"vertexes" : [
		...
		/* 16 */ { "x" : -700, "y" : 85, "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea", "color" : "F8F8F8" },
		/* 17 */ { "x" : -700, "y" : 320, "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea", "color" : "F8F8F8" },
		/* 18 */ { "x" : -700, "y" : -85, "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea", "color" : "F8F8F8" },
		/* 19 */ { "x" : -700, "y" : -320, "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea", "color" : "F8F8F8" },
		/* 20 */ { "x" : -700, "y" : 320, "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea" },
		/* 21 */ { "x" : 700, "y" : 320, "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea" },
		/* 22 */ { "x" : 700, "y" : 85, "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea" },
		/* 23 */ { "x" : 700, "y" : 320, "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea" },
		/* 24 */ { "x" : 700, "y" : -320, "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea", "color" : "F8F8F8" },
		/* 25 */ { "x" : 700, "y" : -85, "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea", "color" : "F8F8F8" },
		/* 26 */ { "x" : 700, "y" : -320, "bCoef" : 0, "cMask" : ["ball" ], "trait" : "ballArea" },
		/* 27 */ { "x" : 700, "y" : -320, "bCoef" : 0, "cMask" : ["ball" ], "trait" : "ballArea" },
		/* 28 */ { "x" : -700, "y" : -320, "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea" },
		/* 29 */ { "x" : 700, "y" : -320, "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea" },
		
		/* 30 */ { "x" : 0, "y" : -320, "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO","blueKO" ], "trait" : "kickOffBarrier" },
		/* 31 */ { "x" : 0, "y" : -80, "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO","blueKO" ], "trait" : "kickOffBarrier" },
		/* 32 */ { "x" : 0, "y" : 80, "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO","blueKO" ], "trait" : "kickOffBarrier" },
		/* 33 */ { "x" : 0, "y" : 320, "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO","blueKO" ], "trait" : "kickOffBarrier" },
		/* 34 */ { "x" : 0, "y" : -80, "bCoef" : 0.1, "cMask" : ["red","blue" ], "trait" : "kickOffBarrier", "vis" : true, "color" : "F8F8F8" },
		/* 35 */ { "x" : 0, "y" : 80, "bCoef" : 0.1, "cMask" : ["red","blue" ], "trait" : "kickOffBarrier", "vis" : true, "color" : "F8F8F8" },
		/* 36 */ { "x" : 0, "y" : -150, "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO","blueKO" ], "trait" : "kickOffBarrier" },
		/* 37 */ { "x" : 0, "y" : 90, "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO","blueKO" ], "trait" : "kickOffBarrier" },
		...
		/* 42 */ { "x" : -700, "y" : 95, "bCoef" : 1, "cMask" : ["ball" ], "trait" : "ballArea", "curve" : 0, "vis" : false },
		/* 43 */ { "x" : -700, "y" : 320, "bCoef" : 1, "cMask" : ["ball" ], "trait" : "ballArea", "curve" : 0, "vis" : false },
		/* 44 */ { "x" : -700, "y" : -316, "bCoef" : 1, "cMask" : ["ball" ], "trait" : "ballArea", "vis" : false, "curve" : 0 },
		/* 45 */ { "x" : -700, "y" : -89, "bCoef" : 1, "cMask" : ["ball" ], "trait" : "ballArea", "vis" : false, "curve" : 0 },
		/* 46 */ { "x" : 700, "y" : -316, "bCoef" : 1, "cMask" : ["ball" ], "trait" : "ballArea", "vis" : false, "curve" : 0 },
		/* 47 */ { "x" : 700, "y" : -89, "bCoef" : 1, "cMask" : ["ball" ], "trait" : "ballArea", "vis" : false, "curve" : 0 },
		/* 48 */ { "x" : 700, "y" : 95, "bCoef" : 1, "cMask" : ["ball" ], "trait" : "ballArea", "curve" : 0, "vis" : false },
		/* 49 */ { "x" : 700, "y" : 320, "bCoef" : 1, "cMask" : ["ball" ], "trait" : "ballArea", "curve" : 0, "vis" : false },
		/* 50 */ { "x" : -700, "y" : 320, "trait" : "ballArea" },
		/* 51 */ { "x" : -700, "y" : -320, "trait" : "ballArea" },
		/* 52 */ { "x" : 700, "y" : 320, "trait" : "ballArea" },
		/* 53 */ { "x" : 700, "y" : -320, "trait" : "ballArea" },
		
		/* 54 */ { "x" : 0, "y" : 350, "trait" : "kickOffBarrier" },
		/* 55 */ { "x" : 0, "y" : 80, "trait" : "kickOffBarrier", "color" : "F8F8F8", "vis" : true, "curve" : 180 },
		/* 56 */ { "x" : 0, "y" : -80, "trait" : "kickOffBarrier", "color" : "F8F8F8", "vis" : true, "curve" : 180 },
		/* 57 */ { "x" : 0, "y" : -350, "trait" : "kickOffBarrier" },
		
		/* 58 */ { "x" : -700, "y" : -85, "trait" : "goalNet", "curve" : 0, "color" : "F8F8F8" },
		/* 59 */ { "x" : -750, "y" : -85, "trait" : "goalNet", "curve" : 0, "color" : "F8F8F8" },
		/* 60 */ { "x" : -750, "y" : 85, "trait" : "goalNet", "curve" : 0, "color" : "F8F8F8" },
		/* 61 */ { "x" : -700, "y" : 85, "trait" : "goalNet", "curve" : 0, "color" : "F8F8F8" },
		/* 62 */ { "x" : 700, "y" : -85, "trait" : "goalNet", "curve" : 0, "color" : "F8F8F8" },
		/* 63 */ { "x" : 750, "y" : -85, "trait" : "goalNet", "curve" : 0, "color" : "F8F8F8" },
		/* 64 */ { "x" : 750, "y" : 85, "trait" : "goalNet", "curve" : 0, "color" : "F8F8F8" },
		/* 65 */ { "x" : 700, "y" : 85, "trait" : "goalNet", "curve" : 0, "color" : "F8F8F8" },
		
		/* 66 */ { "x" : -700, "y" : 85, "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea", "color" : "F8F8F8" },
		/* 67 */ { "x" : -700, "y" : 320, "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea", "color" : "F8F8F8" },
		/* 68 */ { "x" : -700, "y" : -85, "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea", "color" : "F8F8F8" },
		/* 69 */ { "x" : -700, "y" : -320, "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea", "color" : "F8F8F8" },
		/* 70 */ { "x" : -700, "y" : 320, "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea" },
		/* 71 */ { "x" : 700, "y" : 320, "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea" },
		/* 72 */ { "x" : 700, "y" : 85, "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea" },
		/* 73 */ { "x" : 700, "y" : 320, "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea" },
		/* 74 */ { "x" : 700, "y" : -320, "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea", "color" : "F8F8F8" },
		/* 75 */ { "x" : 700, "y" : -85, "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea", "color" : "F8F8F8" },
		/* 76 */ { "x" : 700, "y" : -320, "bCoef" : 0, "cMask" : ["ball" ], "trait" : "ballArea" },
		/* 77 */ { "x" : 700, "y" : -320, "bCoef" : 0, "cMask" : ["ball" ], "trait" : "ballArea" },
		/* 78 */ { "x" : -700, "y" : -320, "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea" },
		/* 79 */ { "x" : 700, "y" : -320, "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea" },
		
		/* 80 */ { "x" : 0, "y" : -320, "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO","blueKO" ], "trait" : "kickOffBarrier" },
		/* 81 */ { "x" : 0, "y" : -80, "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO","blueKO" ], "trait" : "kickOffBarrier" },
		/* 82 */ { "x" : 0, "y" : 80, "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO","blueKO" ], "trait" : "kickOffBarrier" },
		/* 83 */ { "x" : 0, "y" : 320, "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO","blueKO" ], "trait" : "kickOffBarrier" },
		/* 84 */ { "x" : 0, "y" : -80, "bCoef" : 0.1, "cMask" : ["red","blue" ], "trait" : "kickOffBarrier", "vis" : true, "color" : "F8F8F8" },
		/* 85 */ { "x" : 0, "y" : 80, "bCoef" : 0.1, "cMask" : ["red","blue" ], "trait" : "kickOffBarrier", "vis" : true, "color" : "F8F8F8" },
		/* 86 */ { "x" : 0, "y" : -150, "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO","blueKO" ], "trait" : "kickOffBarrier" },
		/* 87 */ { "x" : 0, "y" : 90, "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO","blueKO" ], "trait" : "kickOffBarrier" },
		/* 88 */ { "x" : 0, "y" : 80, "trait" : "kickOffBarrier", "color" : "F8F8F8", "vis" : true, "curve" : -180 },
		/* 89 */ { "x" : 0, "y" : -80, "trait" : "kickOffBarrier", "color" : "F8F8F8", "vis" : true, "curve" : -180 },
		/* 90 */ { "x" : 0, "y" : 80, "trait" : "kickOffBarrier", "color" : "F8F8F8", "vis" : true, "curve" : 0 },
		/* 91 */ { "x" : 0, "y" : -80, "trait" : "kickOffBarrier", "color" : "F8F8F8", "vis" : true, "curve" : 0 },
		
		/* 92 */ { "x" : -700, "y" : 320, "trait" : "ballArea" },
		/* 93 */ { "x" : -700, "y" : -320, "trait" : "ballArea" },
		/* 94 */ { "x" : 700, "y" : 320, "trait" : "ballArea" },
		/* 95 */ { "x" : 700, "y" : -320, "trait" : "ballArea" },
		
		/* 96 */ { "x" : 0, "y" : 350, "trait" : "kickOffBarrier" },
		/* 97 */ { "x" : 0, "y" : 80, "trait" : "kickOffBarrier", "color" : "F8F8F8", "vis" : true, "curve" : 180 },
		/* 98 */ { "x" : 0, "y" : -80, "trait" : "kickOffBarrier", "color" : "F8F8F8", "vis" : true, "curve" : 180 },
		/* 99 */ { "x" : 0, "y" : -350, "trait" : "kickOffBarrier" },
		
		/* 100 */ { "x" : -700, "y" : -85, "trait" : "goalNet", "curve" : 0, "color" : "F8F8F8" },
		/* 101 */ { "x" : -750, "y" : -85, "trait" : "goalNet", "curve" : 0, "color" : "F8F8F8" },
		/* 102 */ { "x" : -750, "y" : 85, "trait" : "goalNet", "curve" : 0, "color" : "F8F8F8" },
		/* 103 */ { "x" : -700, "y" : 85, "trait" : "goalNet", "curve" : 0, "color" : "F8F8F8" },
		/* 104 */ { "x" : 700, "y" : -85, "trait" : "goalNet", "curve" : 0, "color" : "F8F8F8" },
		/* 105 */ { "x" : 750, "y" : -85, "trait" : "goalNet", "curve" : 0, "color" : "F8F8F8" },
		/* 106 */ { "x" : 750, "y" : 85, "trait" : "goalNet", "curve" : 0, "color" : "F8F8F8" },
		/* 107 */ { "x" : 700, "y" : 85, "trait" : "goalNet", "curve" : 0, "color" : "F8F8F8" },
		
		/* 108 */ { "x" : -700, "y" : 85, "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea", "color" : "F8F8F8" },
		/* 109 */ { "x" : -700, "y" : 320, "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea", "color" : "F8F8F8" },
		/* 110 */ { "x" : -700, "y" : -85, "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea", "color" : "F8F8F8" },
		/* 111 */ { "x" : -700, "y" : -320, "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea", "color" : "F8F8F8" },
		/* 112 */ { "x" : -700, "y" : 320, "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea" },
		/* 113 */ { "x" : 700, "y" : 320, "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea" },
		/* 114 */ { "x" : 700, "y" : 85, "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea" },
		/* 115 */ { "x" : 700, "y" : 320, "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea" },
		/* 116 */ { "x" : 700, "y" : -320, "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea", "color" : "F8F8F8" },
		/* 117 */ { "x" : 700, "y" : -85, "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea", "color" : "F8F8F8" },
		/* 118 */ { "x" : 700, "y" : -320, "bCoef" : 0, "cMask" : ["ball" ], "trait" : "ballArea" },
		/* 119 */ { "x" : 700, "y" : -320, "bCoef" : 0, "cMask" : ["ball" ], "trait" : "ballArea" },
		/* 120 */ { "x" : -700, "y" : -320, "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea" },
		/* 121 */ { "x" : 700, "y" : -320, "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea" },
		
		/* 122 */ { "x" : 0, "y" : -320, "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO","blueKO" ], "trait" : "kickOffBarrier" },
		/* 123 */ { "x" : 0, "y" : -80, "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO","blueKO" ], "trait" : "kickOffBarrier" },
		/* 124 */ { "x" : 0, "y" : 80, "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO","blueKO" ], "trait" : "kickOffBarrier" },
		/* 125 */ { "x" : 0, "y" : 320, "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO","blueKO" ], "trait" : "kickOffBarrier" },
		/* 126 */ { "x" : 0, "y" : -80, "bCoef" : 0.1, "cMask" : ["red","blue" ], "trait" : "kickOffBarrier", "vis" : true, "color" : "F8F8F8" },
		/* 127 */ { "x" : 0, "y" : 80, "bCoef" : 0.1, "cMask" : ["red","blue" ], "trait" : "kickOffBarrier", "vis" : true, "color" : "F8F8F8" },
		/* 128 */ { "x" : 0, "y" : -150, "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO","blueKO" ], "trait" : "kickOffBarrier" },
		/* 129 */ { "x" : 0, "y" : 90, "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO","blueKO" ], "trait" : "kickOffBarrier" },
		/* 130 */ { "x" : 0, "y" : 80, "trait" : "kickOffBarrier", "color" : "F8F8F8", "vis" : true, "curve" : -180 },
		/* 131 */ { "x" : 0, "y" : -80, "trait" : "kickOffBarrier", "color" : "F8F8F8", "vis" : true, "curve" : -180 },
		/* 132 */ { "x" : 0, "y" : 80, "trait" : "kickOffBarrier", "color" : "F8F8F8", "vis" : true, "curve" : 0 },
		/* 133 */ { "x" : 0, "y" : -80, "trait" : "kickOffBarrier", "color" : "F8F8F8", "vis" : true, "curve" : 0 },
		
		/* 134 */ { "x" : -700, "y" : 320, "trait" : "ballArea" },
		/* 135 */ { "x" : -700, "y" : -320, "trait" : "ballArea" },
		/* 136 */ { "x" : 700, "y" : 320, "trait" : "ballArea" },
		/* 137 */ { "x" : 700, "y" : -320, "trait" : "ballArea" },
		
		/* 138 */ { "x" : 0, "y" : 350, "trait" : "kickOffBarrier" },
		/* 139 */ { "x" : 0, "y" : 80, "trait" : "kickOffBarrier", "color" : "F8F8F8", "vis" : true, "curve" : 180 },
		/* 140 */ { "x" : 0, "y" : -80, "trait" : "kickOffBarrier", "color" : "F8F8F8", "vis" : true, "curve" : 180 },
		/* 141 */ { "x" : 0, "y" : -350, "trait" : "kickOffBarrier" },
		
		/* 142 */ { "x" : -700, "y" : -85, "trait" : "goalNet", "curve" : 0, "color" : "F8F8F8" },
		/* 143 */ { "x" : -750, "y" : -85, "trait" : "goalNet", "curve" : 0, "color" : "F8F8F8" },
		/* 144 */ { "x" : -750, "y" : 85, "trait" : "goalNet", "curve" : 0, "color" : "F8F8F8" },
		/* 145 */ { "x" : -700, "y" : 85, "trait" : "goalNet", "curve" : 0, "color" : "F8F8F8" },
		/* 146 */ { "x" : 700, "y" : -85, "trait" : "goalNet", "curve" : 0, "color" : "F8F8F8" },
		/* 147 */ { "x" : 750, "y" : -85, "trait" : "goalNet", "curve" : 0, "color" : "F8F8F8" },
		/* 148 */ { "x" : 750, "y" : 85, "trait" : "goalNet", "curve" : 0, "color" : "F8F8F8" },
		/* 149 */ { "x" : 700, "y" : 85, "trait" : "goalNet", "curve" : 0, "color" : "F8F8F8" },
		
		/* 150 */ { "x" : -700, "y" : 85, "bCoef" : 2, "cMask" : ["ball" ], "cGroup" : ["ball" ], "trait" : "ballArea", "color" : "F8F8F8" },
		/* 151 */ { "x" : -700, "y" : 320, "bCoef" : 2, "cMask" : ["ball" ], "cGroup" : ["ball" ], "trait" : "ballArea", "color" : "F8F8F8" },
		/* 152 */ { "x" : -700, "y" : -85, "bCoef" : 2, "cMask" : ["ball" ], "cGroup" : ["ball" ], "trait" : "ballArea", "color" : "F8F8F8" },
		/* 153 */ { "x" : -700, "y" : -320, "bCoef" : 2, "cMask" : ["ball" ], "cGroup" : ["ball" ], "trait" : "ballArea", "color" : "F8F8F8" },
		/* 154 */ { "x" : -700, "y" : 320, "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea" },
		/* 155 */ { "x" : 700, "y" : 320, "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea" },
		/* 156 */ { "x" : 700, "y" : 85, "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea" },
		/* 157 */ { "x" : 700, "y" : 320, "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea" },
		/* 158 */ { "x" : 700, "y" : -320, "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea", "color" : "F8F8F8" },
		/* 159 */ { "x" : 700, "y" : -85, "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea", "color" : "F8F8F8" },
		/* 160 */ { "x" : 700, "y" : -320, "bCoef" : 0, "cMask" : ["ball" ], "trait" : "ballArea" },
		/* 161 */ { "x" : 700, "y" : -320, "bCoef" : 0, "cMask" : ["ball" ], "trait" : "ballArea" },
		/* 162 */ { "x" : -700, "y" : -320, "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea" },
		/* 163 */ { "x" : 700, "y" : -320, "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea" },
		
		/* 164 */ { "x" : 0, "y" : -320, "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO","blueKO" ], "trait" : "kickOffBarrier" },
		/* 165 */ { "x" : 0, "y" : -80, "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO","blueKO" ], "trait" : "kickOffBarrier" },
		/* 166 */ { "x" : 0, "y" : 80, "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO","blueKO" ], "trait" : "kickOffBarrier" },
		/* 167 */ { "x" : 0, "y" : 320, "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO","blueKO" ], "trait" : "kickOffBarrier" },
		/* 168 */ { "x" : 0, "y" : -80, "bCoef" : 0.1, "cMask" : ["red","blue" ], "trait" : "kickOffBarrier", "vis" : true, "color" : "F8F8F8" },
		/* 169 */ { "x" : 0, "y" : 80, "bCoef" : 0.1, "cMask" : ["red","blue" ], "trait" : "kickOffBarrier", "vis" : true, "color" : "F8F8F8" },
		/* 170 */ { "x" : 0, "y" : -150, "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO","blueKO" ], "trait" : "kickOffBarrier" },
		/* 171 */ { "x" : 0, "y" : 90, "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO","blueKO" ], "trait" : "kickOffBarrier" },
		/* 172 */ { "x" : 0, "y" : 80, "trait" : "kickOffBarrier", "color" : "F8F8F8", "vis" : true, "curve" : -180 },
		/* 173 */ { "x" : 0, "y" : -80, "trait" : "kickOffBarrier", "color" : "F8F8F8", "vis" : true, "curve" : -180 },
		/* 174 */ { "x" : 0, "y" : 80, "trait" : "kickOffBarrier", "color" : "F8F8F8", "vis" : true, "curve" : 0 },
		/* 175 */ { "x" : 0, "y" : -80, "trait" : "kickOffBarrier", "color" : "F8F8F8", "vis" : true, "curve" : 0 },
		
		/* 176 */ { "x" : -705, "y" : -85, "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea", "vis" : false, "curve" : 0 },
		
		/* 177 */ { "x" : 1, "y" : -79, "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO","blueKO" ], "trait" : "kickOffBarrier" },
		/* 178 */ { "x" : 0, "y" : 81, "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO","blueKO" ], "trait" : "kickOffBarrier" },
		
		/* 179 */ { "x" : -700, "y" : -266, "bCoef" : 0, "cMask" : ["" ], "trait" : "line", "curve" : 95 },
		/* 180 */ { "x" : -444, "y" : -69, "bCoef" : 0, "cMask" : ["" ], "trait" : "line", "curve" : 95 },
		/* 181 */ { "x" : 700, "y" : -266, "bCoef" : 0, "cMask" : ["" ], "trait" : "line", "curve" : -95 },
		/* 182 */ { "x" : 444, "y" : -69, "bCoef" : 0, "cMask" : ["" ], "trait" : "line", "curve" : -95 },
		/* 183 */ { "x" : -700, "y" : 266, "bCoef" : 2, "cMask" : ["" ], "trait" : "line", "curve" : -95 },
		/* 184 */ { "x" : -444, "y" : 60, "bCoef" : 0, "cMask" : ["" ], "trait" : "line", "curve" : -95 },
		/* 185 */ { "x" : 700, "y" : 266, "bCoef" : 0, "cMask" : ["" ], "trait" : "line", "curve" : 95 },
		/* 186 */ { "x" : 444, "y" : 58, "bCoef" : 0, "cMask" : ["" ], "trait" : "line", "curve" : 95 },
		/* 187 */ { "x" : -405, "y" : 3, "bCoef" : 0.1, "trait" : "line", "curve" : 180 },
		/* 188 */ { "x" : -405, "y" : 1, "bCoef" : 0.1, "trait" : "line", "curve" : 180 },
		/* 189 */ { "x" : -405, "y" : 5, "bCoef" : 0.1, "trait" : "line", "curve" : 180 },
		/* 190 */ { "x" : -405, "y" : -1, "bCoef" : 0.1, "trait" : "line", "curve" : 180 },
		/* 191 */ { "x" : -405, "y" : 0, "bCoef" : 0.1, "trait" : "line", "curve" : 180 },
		/* 192 */ { "x" : -405, "y" : 4, "bCoef" : 0.1, "trait" : "line", "curve" : 180 },
		/* 193 */ { "x" : -405, "y" : -1.5, "bCoef" : 0.1, "trait" : "line", "curve" : 180 },
		/* 194 */ { "x" : -405, "y" : 5.5, "bCoef" : 0.1, "trait" : "line", "curve" : 180 },
		/* 195 */ { "x" : 405, "y" : 3, "bCoef" : 0.1, "trait" : "line", "curve" : 180 },
		/* 196 */ { "x" : 405, "y" : 1, "bCoef" : 0.1, "trait" : "line", "curve" : 180 },
		/* 197 */ { "x" : 405, "y" : 5, "bCoef" : 0.1, "trait" : "line", "curve" : 180 },
		/* 198 */ { "x" : 405, "y" : -1, "bCoef" : 0.1, "trait" : "line", "curve" : 180 },
		/* 199 */ { "x" : 405, "y" : 0, "bCoef" : 0.1, "trait" : "line", "curve" : 180 },
		/* 200 */ { "x" : 405, "y" : 4, "bCoef" : 0.1, "trait" : "line", "curve" : 180 },
		/* 201 */ { "x" : 405, "y" : -1.5, "bCoef" : 0.1, "trait" : "line", "curve" : 180 },
		/* 202 */ { "x" : 405, "y" : 5.5, "bCoef" : 0.1, "trait" : "line", "curve" : 180 },
		
		/* 203 */ { "x" : -700, "y" : 95, "bCoef" : 1, "cMask" : ["ball" ], "trait" : "ballArea", "curve" : 0, "vis" : false },
		/* 204 */ { "x" : -700, "y" : 320, "bCoef" : 1, "cMask" : ["ball" ], "trait" : "ballArea", "curve" : 0, "vis" : false },
		/* 205 */ { "x" : -700, "y" : 95, "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea", "curve" : 0, "vis" : false },
		/* 206 */ { "x" : -700, "y" : 320, "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea", "curve" : 0, "vis" : false },
		/* 207 */ { "x" : -700, "y" : -316, "bCoef" : 1, "cMask" : ["ball" ], "trait" : "ballArea", "vis" : false, "curve" : 0 },
		/* 208 */ { "x" : -700, "y" : -89, "bCoef" : 1, "cMask" : ["ball" ], "trait" : "ballArea", "vis" : false, "curve" : 0 },
		/* 209 */ { "x" : -700, "y" : -316, "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea", "vis" : false, "curve" : 0 },
		/* 210 */ { "x" : -700, "y" : -89, "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea", "vis" : false, "curve" : 0 },
		/* 211 */ { "x" : 700, "y" : -316, "bCoef" : 1, "cMask" : ["ball" ], "trait" : "ballArea", "vis" : false, "curve" : 0 },
		/* 212 */ { "x" : 700, "y" : -89, "bCoef" : 1, "cMask" : ["ball" ], "trait" : "ballArea", "vis" : false, "curve" : 0 },
		/* 213 */ { "x" : 700, "y" : -316, "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea", "vis" : false, "curve" : 0 },
		/* 214 */ { "x" : 700, "y" : -89, "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea", "vis" : false, "curve" : 0 },
		/* 215 */ { "x" : 700, "y" : 95, "bCoef" : 1, "cMask" : ["ball" ], "trait" : "ballArea", "curve" : 0, "vis" : false },
		/* 216 */ { "x" : 700, "y" : 320, "bCoef" : 1, "cMask" : ["ball" ], "trait" : "ballArea", "curve" : 0, "vis" : false },
		/* 217 */ { "x" : 700, "y" : 95, "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea", "curve" : 0, "vis" : false },
		/* 218 */ { "x" : 700, "y" : 320, "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea", "curve" : 0, "vis" : false },
		/* 219 */ { "x" : -707, "y" : 87, "bCoef" : 1.5, "cMask" : ["ball" ], "cGroup" : ["ball" ], "trait" : "ballArea" },
		/* 220 */ { "x" : -707, "y" : 318, "bCoef" : 1.5, "cMask" : ["ball" ], "cGroup" : ["ball" ], "trait" : "ballArea" },
		/* 221 */ { "x" : -707, "y" : -320, "bCoef" : 1.5, "cMask" : ["ball" ], "cGroup" : ["ball" ], "trait" : "ballArea" },
		/* 222 */ { "x" : -707, "y" : -89, "bCoef" : 1.5, "cMask" : ["ball" ], "cGroup" : ["ball" ], "trait" : "ballArea" },
		/* 223 */ { "x" : 707, "y" : -320, "bCoef" : 1.5, "cMask" : ["ball" ], "cGroup" : ["ball" ], "trait" : "ballArea" },
		/* 224 */ { "x" : 707, "y" : -89, "bCoef" : 1.5, "cMask" : ["ball" ], "cGroup" : ["ball" ], "trait" : "ballArea" },
		/* 225 */ { "x" : 707, "y" : 86, "bCoef" : 1.5, "cMask" : ["ball" ], "cGroup" : ["ball" ], "trait" : "ballArea" },
		/* 226 */ { "x" : 707, "y" : 317, "bCoef" : 1.5, "cMask" : ["ball" ], "cGroup" : ["ball" ], "trait" : "ballArea" },
		
		/* 227 */ { "bCoef" : 0, "trait" : "line", "x" : 700, "y" : 83, "curve" : 0, "color" : "0000b3" },
		/* 228 */ { "bCoef" : 0, "trait" : "line", "x" : 700, "y" : -83, "curve" : 0, "color" : "0000b3" },
		/* 229 */ { "bCoef" : 0, "trait" : "line", "x" : -700, "y" : -85, "color" : "cc0000" },
		/* 230 */ { "bCoef" : 0, "trait" : "line", "x" : -700, "y" : 85, "color" : "cc0000" },
		/* 231 */ { "bCoef" : 0, "trait" : "line", "x" : -47, "y" : -35, "color" : "ffff1a" },
		/* 232 */ { "bCoef" : 0, "trait" : "line", "x" : -48, "y" : 21, "color" : "ffff1a" },
		/* 233 */ { "bCoef" : 0, "trait" : "line", "x" : 6, "y" : -35, "color" : "ffff1a" },
		/* 234 */ { "bCoef" : 0, "trait" : "line", "x" : 49, "y" : -35, "color" : "ffff1a" },
		/* 235 */ { "bCoef" : 0, "trait" : "line", "x" : -47, "y" : -35, "color" : "ffff1a" },
		/* 236 */ { "bCoef" : 0, "trait" : "line", "x" : -21, "y" : -8, "color" : "ffff1a" },
		/* 237 */ { "bCoef" : 0, "trait" : "line", "x" : 49, "y" : -35, "color" : "ffff1a" },
		/* 238 */ { "bCoef" : 0, "trait" : "line", "x" : 2, "y" : 21, "color" : "ffff1a" },
		/* 239 */ { "bCoef" : 0, "trait" : "line", "x" : 2, "y" : 21, "color" : "ffff1a" },
		/* 240 */ { "bCoef" : 0, "trait" : "line", "x" : 45, "y" : 21, "color" : "ffff1a" }
	...
	"segments" : [
		...
		{ "v0" : 12, "v1" : 13, "curve" : 0, "color" : "F8F8F8", "trait" : "goalNet" },
		{ "v0" : 13, "v1" : 14, "color" : "F8F8F8", "trait" : "goalNet" },
		{ "v0" : 14, "v1" : 15, "curve" : 0, "color" : "F8F8F8", "trait" : "goalNet" },
		
		{ "v0" : 4, "v1" : 5, "trait" : "kickOffBarrier" },
		{ "v0" : 5, "v1" : 6, "curve" : 180, "vis" : true, "color" : "F8F8F8", "cGroup" : ["blueKO" ], "trait" : "kickOffBarrier" },
		{ "v0" : 5, "v1" : 6, "curve" : -180, "vis" : true, "color" : "F8F8F8", "cGroup" : ["redKO" ], "trait" : "kickOffBarrier" },
		{ "v0" : 6, "v1" : 7, "trait" : "kickOffBarrier" },
		
		{ "v0" : 16, "v1" : 17, "vis" : true, "color" : "F8F8F8", "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea" },
		{ "v0" : 18, "v1" : 19, "vis" : true, "color" : "F8F8F8", "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea" },
		{ "v0" : 20, "v1" : 21, "vis" : true, "color" : "F8F8F8", "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea" },
		{ "v0" : 22, "v1" : 23, "vis" : true, "color" : "F8F8F8", "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea" },
		{ "v0" : 24, "v1" : 25, "vis" : true, "color" : "F8F8F8", "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea" },
		{ "v0" : 26, "v1" : 27, "vis" : true, "color" : "F8F8F8", "bCoef" : 0, "cMask" : ["ball" ], "trait" : "ballArea" },
		{ "v0" : 28, "v1" : 29, "vis" : true, "color" : "F8F8F8", "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea" },
		
		{ "v0" : 30, "v1" : 31, "vis" : true, "color" : "F8F8F8", "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO","blueKO" ], "trait" : "kickOffBarrier" },
		{ "v0" : 32, "v1" : 33, "vis" : true, "color" : "F8F8F8", "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO","blueKO" ], "trait" : "kickOffBarrier" },
		
		{ "v0" : 42, "v1" : 43, "curve" : 0, "vis" : false, "color" : "F8F8F8", "bCoef" : 1, "cMask" : ["ball" ], "trait" : "ballArea", "x" : -700 },
		{ "v0" : 44, "v1" : 45, "curve" : 0, "vis" : false, "color" : "F8F8F8", "bCoef" : 1, "cMask" : ["ball" ], "trait" : "ballArea", "x" : -700 },
		{ "v0" : 46, "v1" : 47, "curve" : 0, "vis" : false, "color" : "F8F8F8", "bCoef" : 1, "cMask" : ["ball" ], "trait" : "ballArea", "x" : 700 },
		{ "v0" : 48, "v1" : 49, "curve" : 2.50208708167, "vis" : false, "color" : "F8F8F8", "bCoef" : 1, "cMask" : ["ball" ], "trait" : "ballArea", "x" : 700 },
		
		{ "v0" : 58, "v1" : 59, "curve" : 0, "color" : "F8F8F8", "trait" : "goalNet" },
		{ "v0" : 59, "v1" : 60, "color" : "F8F8F8", "trait" : "goalNet" },
		{ "v0" : 60, "v1" : 61, "curve" : 0, "color" : "F8F8F8", "trait" : "goalNet" },
		{ "v0" : 62, "v1" : 63, "curve" : 0, "color" : "F8F8F8", "trait" : "goalNet" },
		{ "v0" : 63, "v1" : 64, "color" : "F8F8F8", "trait" : "goalNet" },
		{ "v0" : 64, "v1" : 65, "curve" : 0, "color" : "F8F8F8", "trait" : "goalNet" },
		
		{ "v0" : 54, "v1" : 55, "trait" : "kickOffBarrier" },
		{ "v0" : 55, "v1" : 56, "curve" : 180, "vis" : true, "color" : "F8F8F8", "cGroup" : ["blueKO" ], "trait" : "kickOffBarrier" },
		{ "v0" : 55, "v1" : 56, "curve" : -180, "vis" : true, "color" : "F8F8F8", "cGroup" : ["redKO" ], "trait" : "kickOffBarrier" },
		{ "v0" : 56, "v1" : 57, "trait" : "kickOffBarrier" },
		
		{ "v0" : 66, "v1" : 67, "vis" : true, "color" : "F8F8F8", "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea" },
		{ "v0" : 68, "v1" : 69, "vis" : true, "color" : "F8F8F8", "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea" },
		{ "v0" : 70, "v1" : 71, "vis" : true, "color" : "F8F8F8", "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea" },
		{ "v0" : 72, "v1" : 73, "vis" : true, "color" : "F8F8F8", "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea" },
		{ "v0" : 74, "v1" : 75, "vis" : true, "color" : "F8F8F8", "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea" },
		{ "v0" : 76, "v1" : 77, "vis" : true, "color" : "F8F8F8", "bCoef" : 0, "cMask" : ["ball" ], "trait" : "ballArea" },
		{ "v0" : 78, "v1" : 79, "vis" : true, "color" : "F8F8F8", "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea" },
		
		{ "v0" : 80, "v1" : 81, "vis" : true, "color" : "F8F8F8", "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO","blueKO" ], "trait" : "kickOffBarrier" },
		{ "v0" : 82, "v1" : 83, "vis" : true, "color" : "F8F8F8", "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO","blueKO" ], "trait" : "kickOffBarrier" },
		
		{ "v0" : 100, "v1" : 101, "curve" : 0, "color" : "F8F8F8", "trait" : "goalNet" },
		{ "v0" : 101, "v1" : 102, "color" : "F8F8F8", "trait" : "goalNet" },
		{ "v0" : 102, "v1" : 103, "curve" : 0, "color" : "F8F8F8", "trait" : "goalNet" },
		{ "v0" : 104, "v1" : 105, "curve" : 0, "color" : "F8F8F8", "trait" : "goalNet" },
		{ "v0" : 105, "v1" : 106, "color" : "F8F8F8", "trait" : "goalNet" },
		{ "v0" : 106, "v1" : 107, "curve" : 0, "color" : "F8F8F8", "trait" : "goalNet" },
		
		{ "v0" : 96, "v1" : 97, "trait" : "kickOffBarrier" },
		{ "v0" : 97, "v1" : 98, "curve" : 180, "vis" : true, "color" : "F8F8F8", "cGroup" : ["blueKO" ], "trait" : "kickOffBarrier" },
		{ "v0" : 97, "v1" : 98, "curve" : -180, "vis" : true, "color" : "F8F8F8", "cGroup" : ["redKO" ], "trait" : "kickOffBarrier" },
		{ "v0" : 98, "v1" : 99, "trait" : "kickOffBarrier" },
		
		{ "v0" : 108, "v1" : 109, "vis" : true, "color" : "F8F8F8", "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea" },
		{ "v0" : 110, "v1" : 111, "vis" : true, "color" : "F8F8F8", "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea" },
		{ "v0" : 112, "v1" : 113, "vis" : true, "color" : "F8F8F8", "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea" },
		{ "v0" : 114, "v1" : 115, "vis" : true, "color" : "F8F8F8", "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea" },
		{ "v0" : 116, "v1" : 117, "vis" : true, "color" : "F8F8F8", "bCoef" : 1.25, "cMask" : ["ball" ], "trait" : "ballArea" },
		{ "v0" : 118, "v1" : 119, "vis" : true, "color" : "F8F8F8", "bCoef" : 0, "cMask" : ["ball" ], "trait" : "ballArea" },
		{ "v0" : 120, "v1" : 121, "vis" : true, "color" : "F8F8F8", "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea" },
		
		{ "v0" : 122, "v1" : 123, "vis" : true, "color" : "F8F8F8", "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO","blueKO" ], "trait" : "kickOffBarrier" },
		{ "v0" : 124, "v1" : 125, "vis" : true, "color" : "F8F8F8", "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO","blueKO" ], "trait" : "kickOffBarrier" },
		
		{ "v0" : 142, "v1" : 143, "curve" : 0, "color" : "F8F8F8", "trait" : "goalNet" },
		{ "v0" : 143, "v1" : 144, "color" : "F8F8F8", "trait" : "goalNet" },
		{ "v0" : 144, "v1" : 145, "curve" : 0, "color" : "F8F8F8", "trait" : "goalNet" },
		{ "v0" : 146, "v1" : 147, "curve" : 0, "color" : "F8F8F8", "trait" : "goalNet" },
		{ "v0" : 147, "v1" : 148, "color" : "F8F8F8", "trait" : "goalNet" },
		{ "v0" : 148, "v1" : 149, "curve" : 0, "color" : "F8F8F8", "trait" : "goalNet" },
		
		{ "v0" : 139, "v1" : 140, "curve" : 180, "vis" : true, "color" : "F8F8F8", "cGroup" : ["blueKO" ], "trait" : "kickOffBarrier" },
		{ "v0" : 139, "v1" : 140, "curve" : -180, "vis" : true, "color" : "F8F8F8", "cGroup" : ["redKO" ], "trait" : "kickOffBarrier" },
		{ "v0" : 140, "v1" : 141, "trait" : "kickOffBarrier" },
		
		{ "v0" : 150, "v1" : 151, "vis" : true, "color" : "F8F8F8", "bCoef" : 2, "cMask" : ["ball" ], "cGroup" : ["ball" ], "trait" : "ballArea" },
		{ "v0" : 152, "v1" : 153, "vis" : true, "color" : "F8F8F8", "bCoef" : 2, "cMask" : ["ball" ], "cGroup" : ["ball" ], "trait" : "ballArea" },
		{ "v0" : 154, "v1" : 155, "vis" : true, "color" : "F8F8F8", "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea" },
		{ "v0" : 156, "v1" : 157, "vis" : true, "color" : "F8F8F8", "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea" },
		{ "v0" : 158, "v1" : 159, "vis" : true, "color" : "F8F8F8", "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea" },
		{ "v0" : 160, "v1" : 161, "vis" : true, "color" : "F8F8F8", "bCoef" : 0, "cMask" : ["ball" ], "trait" : "ballArea" },
		{ "v0" : 162, "v1" : 163, "vis" : true, "color" : "F8F8F8", "bCoef" : 2, "cMask" : ["ball" ], "trait" : "ballArea" },
		
		{ "v0" : 164, "v1" : 165, "vis" : true, "color" : "F8F8F8", "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO","blueKO" ], "trait" : "kickOffBarrier" },
		{ "v0" : 166, "v1" : 167, "vis" : true, "color" : "F8F8F8", "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO","blueKO" ], "trait" : "kickOffBarrier" },
		
		{ "v0" : 179, "v1" : 180, "curve" : 95, "vis" : true, "color" : "F8F8F8", "bCoef" : 0, "cMask" : ["" ], "trait" : "line" },
		{ "v0" : 181, "v1" : 182, "curve" : -95, "vis" : true, "color" : "F8F8F8", "bCoef" : 0, "cMask" : ["" ], "trait" : "line" },
		{ "v0" : 183, "v1" : 184, "curve" : -95, "vis" : true, "color" : "F8F8F8", "bCoef" : 0, "cMask" : ["" ], "trait" : "line" },
		{ "v0" : 185, "v1" : 186, "curve" : 95, "vis" : true, "color" : "F8F8F8", "bCoef" : 0, "cMask" : ["" ], "trait" : "line" },
		{ "v0" : 180, "v1" : 184, "curve" : 0, "vis" : true, "color" : "F8F8F8", "bCoef" : 0, "cMask" : ["" ], "trait" : "line" },
		{ "v0" : 182, "v1" : 186, "curve" : 0, "vis" : true, "color" : "F8F8F8", "bCoef" : 0, "cMask" : ["" ], "trait" : "line" },
		{ "v0" : 188, "v1" : 187, "curve" : 180, "vis" : true, "color" : "F8F8F8", "bCoef" : 0.1, "trait" : "line", "x" : -405 },
		{ "v0" : 187, "v1" : 188, "curve" : 180, "vis" : true, "color" : "F8F8F8", "bCoef" : 0.1, "trait" : "line", "x" : -405 },
		{ "v0" : 190, "v1" : 189, "curve" : 180, "vis" : true, "color" : "F8F8F8", "bCoef" : 0.1, "trait" : "line", "x" : -405 },
		{ "v0" : 189, "v1" : 190, "curve" : 180, "vis" : true, "color" : "F8F8F8", "bCoef" : 0.1, "trait" : "line", "x" : -405 },
		{ "v0" : 192, "v1" : 191, "curve" : 180, "vis" : true, "color" : "F8F8F8", "bCoef" : 0.1, "trait" : "line", "x" : -405 },
		{ "v0" : 191, "v1" : 192, "curve" : 180, "vis" : true, "color" : "F8F8F8", "bCoef" : 0.1, "trait" : "line", "x" : -405 },
		{ "v0" : 194, "v1" : 193, "curve" : 180, "vis" : true, "color" : "F8F8F8", "bCoef" : 0.1, "trait" : "line", "x" : -405 },
		{ "v0" : 193, "v1" : 194, "curve" : 180, "vis" : true, "color" : "F8F8F8", "bCoef" : 0.1, "trait" : "line", "x" : -405 },
		{ "v0" : 196, "v1" : 195, "curve" : 180, "vis" : true, "color" : "F8F8F8", "bCoef" : 0.1, "trait" : "line", "x" : 405 },
		{ "v0" : 195, "v1" : 196, "curve" : 180, "vis" : true, "color" : "F8F8F8", "bCoef" : 0.1, "trait" : "line", "x" : 405 },
		{ "v0" : 198, "v1" : 197, "curve" : 180, "vis" : true, "color" : "F8F8F8", "bCoef" : 0.1, "trait" : "line", "x" : 405 },
		{ "v0" : 197, "v1" : 198, "curve" : 180, "vis" : true, "color" : "F8F8F8", "bCoef" : 0.1, "trait" : "line", "x" : 405 },
		{ "v0" : 200, "v1" : 199, "curve" : 180, "vis" : true, "color" : "F8F8F8", "bCoef" : 0.1, "trait" : "line", "x" : 405 },
		{ "v0" : 199, "v1" : 200, "curve" : 180, "vis" : true, "color" : "F8F8F8", "bCoef" : 0.1, "trait" : "line", "x" : 405 },
		{ "v0" : 202, "v1" : 201, "curve" : 180, "vis" : true, "color" : "F8F8F8", "bCoef" : 0.1, "trait" : "line", "x" : 405 },
		{ "v0" : 201, "v1" : 202, "curve" : 180, "vis" : true, "color" : "F8F8F8", "bCoef" : 0.1, "trait" : "line", "x" : 405 },
		
		{ "v0" : 219, "v1" : 220, "vis" : false, "bCoef" : 1.5, "cMask" : ["ball" ], "cGroup" : ["ball" ], "trait" : "ballArea", "x" : -707 },
		{ "v0" : 221, "v1" : 222, "vis" : false, "bCoef" : 1.5, "cMask" : ["ball" ], "cGroup" : ["ball" ], "trait" : "ballArea", "x" : -707 },
		{ "v0" : 223, "v1" : 224, "vis" : false, "bCoef" : 1.5, "cMask" : ["ball" ], "cGroup" : ["ball" ], "trait" : "ballArea", "x" : 707 },
		{ "v0" : 225, "v1" : 226, "vis" : false, "bCoef" : 1.5, "cMask" : ["ball" ], "cGroup" : ["ball" ], "trait" : "ballArea", "x" : 707 },
		
		{ "curve" : 0, "vis" : true, "color" : "0000b3", "bCoef" : 0, "trait" : "line", "v0" : 227, "v1" : 228 },
		{ "curve" : 0, "vis" : true, "color" : "cc0000", "bCoef" : 0, "trait" : "line", "v0" : 229, "v1" : 230 }
	...
	"discs" : [
		{ "radius" : 6, "pos" : [-700,85 ], "color" : "FF0000", "trait" : "goalPost" },
		{ "radius" : 6, "pos" : [-700,-85 ], "color" : "FF0000", "trait" : "goalPost" },
		{ "radius" : 6, "pos" : [700,85 ], "color" : "0033FF", "trait" : "goalPost" },
		{ "radius" : 6, "pos" : [700,-85 ], "color" : "0033FF", "trait" : "goalPost" },
		{ "radius" : 6, "pos" : [-700,85 ], "color" : "FF0000", "trait" : "goalPost" },
		{ "radius" : 6, "pos" : [-700,-85 ], "color" : "FF0000", "trait" : "goalPost" },
		{ "radius" : 6, "pos" : [700,85 ], "color" : "0033FF", "trait" : "goalPost" },
...
var Futsalx3=`
{
	...
	"vertexes" : [
		...
		/* 103 */ { "x" : -240, "y" : 256, "bCoef" : 0.1, "trait" : "line" },
		/* 104 */ { "x" : -120, "y" : 256, "bCoef" : 0.1, "trait" : "line" },
		/* 105 */ { "x" : 240, "y" : 256, "bCoef" : 0.1, "trait" : "line" },
		/* 106 */ { "x" : 120, "y" : 256, "bCoef" : 0.1, "trait" : "line" },
		/* 107 */ { "x" : -381, "y" : 240, "bCoef" : 0.1, "trait" : "line" },
		/* 108 */ { "x" : -556, "y" : 123, "bCoef" : 0.1, "trait" : "line" },
		/* 109 */ { "x" : -575, "y" : 123, "bCoef" : 0.1, "trait" : "line" },
		/* 110 */ { "x" : 556, "y" : 123, "bCoef" : 0.1, "trait" : "line" },
		/* 111 */ { "x" : 575, "y" : 123, "bCoef" : 0.1, "trait" : "line" },
		/* 112 */ { "x" : -556, "y" : -123, "bCoef" : 0.1, "trait" : "line" },
		/* 113 */ { "x" : -575, "y" : -123, "bCoef" : 0.1, "trait" : "line" },
		/* 114 */ { "x" : 556, "y" : -123, "bCoef" : 0.1, "trait" : "line" },
		/* 115 */ { "x" : 575, "y" : -123, "bCoef" : 0.1, "trait" : "line" },
		/* 116 */ { "x" : -381, "y" : -240, "bCoef" : 0.1, "trait" : "line" },
		/* 117 */ { "x" : 381, "y" : 240, "bCoef" : 0.1, "trait" : "line" },
		/* 118 */ { "x" : 381, "y" : -240, "bCoef" : 0.1, "trait" : "line" },
		
		/* 119 */ { "x" : 553, "y" : -240, "bCoef" : 0, "cMask" : ["ball" ], "trait" : "ballArea", "color" : "F8F8F8", "vis" : false },
		/* 120 */ { "x" : 553, "y" : -80, "bCoef" : 0, "cMask" : ["ball" ], "trait" : "ballArea", "color" : "F8F8F8", "pos" : [700,-80 ], "vis" : false },
		/* 121 */ { "x" : 553, "y" : 80, "bCoef" : 0, "cMask" : ["ball" ], "trait" : "ballArea", "pos" : [700,80 ], "vis" : false },
		/* 122 */ { "x" : 553, "y" : 240, "bCoef" : 0, "cMask" : ["ball" ], "trait" : "ballArea", "vis" : false },
		/* 123 */ { "x" : -553, "y" : 80, "bCoef" : 0, "cMask" : ["ball" ], "trait" : "ballArea", "color" : "F8F8F8", "pos" : [-700,80 ], "vis" : false },
		/* 124 */ { "x" : -553, "y" : 240, "bCoef" : 0, "cMask" : ["ball" ], "trait" : "ballArea", "color" : "F8F8F8", "vis" : false },
		/* 125 */ { "x" : -553, "y" : -80, "bCoef" : 0, "cMask" : ["ball" ], "trait" : "ballArea", "color" : "F8F8F8", "pos" : [-700,-80 ], "vis" : false },
		/* 126 */ { "x" : -553, "y" : -240, "bCoef" : 0, "cMask" : ["ball" ], "trait" : "ballArea", "color" : "F8F8F8", "vis" : false }
	...
	"segments" : [
		...
		{ "v0" : 119, "v1" : 120, "vis" : false, "color" : "F8F8F8", "bCoef" : 0, "cMask" : ["ball" ], "trait" : "ballArea", "x" : 553 },
		{ "v0" : 121, "v1" : 122, "vis" : false, "color" : "F8F8F8", "bCoef" : 0, "cMask" : ["ball" ], "trait" : "ballArea", "x" : 553 },
		{ "v0" : 123, "v1" : 124, "vis" : false, "color" : "F8F8F8", "bCoef" : 0, "cMask" : ["ball" ], "trait" : "ballArea", "x" : -553 },
		{ "v0" : 125, "v1" : 126, "vis" : false, "color" : "F8F8F8", "bCoef" : 0, "cMask" : ["ball" ], "trait" : "ballArea", "x" : -553 }
...
var PensRedFutsalx3x4=`
{
	...
	"name" : "🌟 𝗣𝗘𝗡𝗔𝗟𝗧𝗜 𝗥𝗘𝗗  🎩discord.gg/kQ5FhMe - v1.0",
	...
	"vertexes" : [
		/* 0 */ { "x" : 460, "y" : -440, "trait" : "art" },
		/* 1 */ { "x" : 460, "y" : -35, "trait" : "art" },
		/* 2 */ { "x" : 460, "y" : 35, "trait" : "art" },
		/* 3 */ { "x" : 460, "y" : 440, "trait" : "art" },
		/* 4 */ { "x" : -460, "y" : -440, "trait" : "art" },
		/* 5 */ { "x" : -460, "y" : -35, "trait" : "art" },
		/* 6 */ { "x" : -460, "y" : 35, "trait" : "art" },
		/* 7 */ { "x" : -460, "y" : 440, "trait" : "art" },
		/* 8 */ { "x" : -280, "y" : -95, "trait" : "art" },
		/* 9 */ { "x" : -280, "y" : 95, "trait" : "art" },
		/* 10 */ { "x" : -320, "y" : -95, "trait" : "art" },
		/* 11 */ { "x" : -320, "y" : 95, "trait" : "art" },
		/* 12 */ { "x" : -280, "y" : -440, "trait" : "art" },
		/* 13 */ { "x" : -280, "y" : 440, "trait" : "art" },
		/* 14 */ { "x" : 0, "y" : -65, "trait" : "art" },
		/* 15 */ { "x" : -280, "y" : -330, "trait" : "art" },
		/* 16 */ { "x" : -280, "y" : 330, "trait" : "art" },
		/* 17 */ { "x" : 0, "y" : 65, "trait" : "art" },
		/* 18 */ { "x" : 0, "y" : 4, "trait" : "art" },
		/* 19 */ { "x" : 0, "y" : -4, "trait" : "art" },
		/* 20 */ { "x" : -280, "y" : -95, "trait" : "art" },
		/* 21 */ { "x" : -280, "y" : -440, "trait" : "art" },
		/* 22 */ { "x" : -280, "y" : 95, "trait" : "art" },
		/* 23 */ { "x" : -280, "y" : 440, "trait" : "art" },
		/* 24 */ { "x" : -265, "y" : -95, "trait" : "art" },
		/* 25 */ { "x" : -265, "y" : 95, "trait" : "art" },
		/* 26 */ { "x" : -295, "y" : -440, "trait" : "art" },
		/* 27 */ { "x" : -295, "y" : -15, "trait" : "art" },
		/* 28 */ { "x" : -295, "y" : 15, "trait" : "art" },
		/* 29 */ { "x" : -295, "y" : 440, "trait" : "art" },
		/* 30 */ { "x" : -295, "y" : -15, "trait" : "art" },
		/* 31 */ { "x" : -440, "y" : -15, "trait" : "art" },
		/* 32 */ { "x" : -440, "y" : 15, "trait" : "art" },
		/* 33 */ { "x" : -295, "y" : 15, "trait" : "art" },
		/* 34 */ { "x" : 460, "y" : -440, "trait" : "art" },
		/* 35 */ { "x" : 460, "y" : 440, "trait" : "art" },
		/* 36 */ { "x" : -278, "y" : -95, "trait" : "art" },
		/* 37 */ { "x" : -278, "y" : 95, "trait" : "art" },
		/* 38 */ { "x" : -282, "y" : -95, "trait" : "art" },
		/* 39 */ { "x" : -282, "y" : 95, "trait" : "art" },
		/* 40 */ { "x" : -280, "y" : 440, "trait" : "art" },
		/* 41 */ { "x" : -280, "y" : -440, "trait" : "art" },
		
		/* 42 */ { "x" : 0, "y" : 0, "cMask" : ["blue" ] },
		/* 43 */ { "x" : 0, "y" : 0, "cMask" : ["blue" ] },
		
		/* 44 */ { "x" : -438, "y" : -15, "trait" : "art" },
		/* 45 */ { "x" : -438, "y" : 15, "trait" : "art" },
		/* 46 */ { "x" : -442, "y" : -14, "trait" : "art" },
		/* 47 */ { "x" : -442, "y" : 14, "trait" : "art" },
		/* 48 */ { "x" : 440, "y" : -15, "trait" : "art" },
		/* 49 */ { "x" : 440, "y" : 15, "trait" : "art" },
		/* 50 */ { "x" : 442, "y" : -15, "trait" : "art" },
		/* 51 */ { "x" : 442, "y" : 15, "trait" : "art" },
		/* 52 */ { "x" : 438, "y" : -15, "trait" : "art" },
		/* 53 */ { "x" : 438, "y" : 15, "trait" : "art" }
	...
	"goals" : [
		{ "team" : "blue", "p0" : [-280,-100 ], "p1" : [20,0 ] },
		{ "team" : "blue", "p0" : [-280,100 ], "p1" : [20,0 ] },
		{ "team" : "red", "p0" : [-286,95 ], "p1" : [-286,-95 ] }

	],

	"discs" : [
		{ "pos" : [-280,-95 ], "radius" : 5, "invMass" : 0, "color" : "8b0000" },
		{ "pos" : [-280,95 ], "radius" : 5, "invMass" : 0, "color" : "8b0000" },
		{ "pos" : [-280,-440 ], "radius" : 3, "cGroup" : ["" ], "color" : "8b0000" },
		{ "pos" : [-280,440 ], "radius" : 3, "cGroup" : ["" ], "color" : "8b0000" },
		{ "pos" : [440,15 ], "radius" : 2, "cGroup" : ["" ], "color" : "00008b" },
		{ "pos" : [440,-15 ], "radius" : 2, "cGroup" : ["" ], "color" : "00008b" },
		{ "pos" : [-440,15 ], "radius" : 2, "cGroup" : ["" ], "color" : "8b0000" },
		{ "pos" : [-440,-15 ], "radius" : 2, "cGroup" : ["" ], "color" : "8b0000" }
...
var PensBlueFutsalx3x4=`
{
	...
	"name" : "🌟 𝗣𝗘𝗡𝗔𝗟𝗧𝗜 𝗕𝗟𝗨𝗘 🎩discord.gg/kQ5FhMe - v1.0",
	...
	"vertexes" : [
		/* 0 */ { "x" : -460, "y" : -440, "trait" : "art" },
		/* 1 */ { "x" : -460, "y" : -35, "trait" : "art", "curve" : -90 },
		/* 2 */ { "x" : -460, "y" : 35, "trait" : "art", "curve" : -90 },
		/* 3 */ { "x" : -460, "y" : 440, "trait" : "art" },
		/* 4 */ { "x" : 460, "y" : -440, "trait" : "art" },
		/* 5 */ { "x" : 460, "y" : -35, "trait" : "art", "curve" : 90 },
		/* 6 */ { "x" : 460, "y" : 35, "trait" : "art", "curve" : -90 },
		/* 7 */ { "x" : 460, "y" : 440, "trait" : "art" },
		/* 8 */ { "x" : 280, "y" : -95, "trait" : "art" },
		/* 9 */ { "x" : 280, "y" : 95, "trait" : "art" },
		/* 10 */ { "x" : 320, "y" : -95, "trait" : "art" },
		...
		/* 12 */ { "x" : 280, "y" : -440, "trait" : "art" },
		/* 13 */ { "x" : 280, "y" : 440, "trait" : "art" },
		/* 14 */ { "x" : 0, "y" : -65, "trait" : "art", "curve" : 95 },
		/* 15 */ { "x" : 280, "y" : -330, "trait" : "art", "curve" : 95 },
		/* 16 */ { "x" : 280, "y" : 330, "trait" : "art", "curve" : 95 },
		/* 17 */ { "x" : 0, "y" : 65, "trait" : "art", "curve" : 95 },
		/* 18 */ { "x" : 0, "y" : 4, "trait" : "art" },
		/* 19 */ { "x" : 0, "y" : -4, "trait" : "art" },
		/* 20 */ { "x" : 280, "y" : -95, "trait" : "art" },
		/* 21 */ { "x" : 280, "y" : -440, "trait" : "art" },
		...
		/* 29 */ { "x" : 295, "y" : 440, "trait" : "art" },
		/* 30 */ { "x" : 295, "y" : -15, "trait" : "art" },
		/* 31 */ { "x" : 440, "y" : -15, "trait" : "art", "curve" : 90 },
		/* 32 */ { "x" : 440, "y" : 15, "trait" : "art", "curve" : -90 },
		/* 33 */ { "x" : 295, "y" : 15, "trait" : "art" },
		/* 34 */ { "x" : -460, "y" : -440, "trait" : "art" },
		/* 35 */ { "x" : -460, "y" : 440, "trait" : "art" },
		/* 36 */ { "x" : 278, "y" : -95, "trait" : "art" },
		...
		/* 46 */ { "x" : 442, "y" : -14, "trait" : "art" },
		/* 47 */ { "x" : 442, "y" : 14, "trait" : "art" },
		/* 48 */ { "x" : -440, "y" : -15, "trait" : "art", "curve" : -90 },
		/* 49 */ { "x" : -440, "y" : 15, "trait" : "art", "curve" : -90 },
		/* 50 */ { "x" : -442, "y" : -15, "trait" : "art" },
		/* 51 */ { "x" : -442, "y" : 15, "trait" : "art" },
		/* 52 */ { "x" : -438, "y" : -15, "trait" : "art" },
		/* 53 */ { "x" : -438, "y" : 15, "trait" : "art" }
	...
	"goals" : [
		{ "team" : "red", "p0" : [280,-100 ], "p1" : [-20,0 ] },
		{ "team" : "red", "p0" : [280,100 ], "p1" : [-20,0 ] },
		{ "team" : "blue", "p0" : [286,95 ], "p1" : [286,-95 ] }

	],

	"discs" : [
		{ "pos" : [280,-95 ], "radius" : 5, "invMass" : 0, "color" : "00008b" },
		{ "pos" : [280,95 ], "radius" : 5, "invMass" : 0, "color" : "00008b" },
		{ "pos" : [280,-440 ], "radius" : 3, "cGroup" : ["" ], "color" : "00008b" },
		{ "pos" : [280,440 ], "radius" : 3, "cGroup" : ["" ], "color" : "00008b" },
		{ "pos" : [-440,15 ], "radius" : 2, "cGroup" : ["" ], "color" : "8b0000" },
		{ "pos" : [-440,-15 ], "radius" : 2, "cGroup" : ["" ], "color" : "8b0000" },
		{ "pos" : [440,15 ], "radius" : 2, "cGroup" : ["" ], "color" : "00008b" },
...
var Futsalx1yx2=`
{
	...
	"vertexes" : [
		...
		/* 87 */ { "x" : -80.337702205015, "y" : -159.39453936245, "bCoef" : 0.1, "trait" : "line" },
		/* 88 */ { "x" : 160.41249829706, "y" : -159.39453936245, "bCoef" : 0.1, "trait" : "line" },
		/* 89 */ { "x" : 160.41249829706, "y" : -182.09086327183, "bCoef" : 0.1, "trait" : "line" },
		/* 90 */ { "x" : 80.162431463036, "y" : -159.39453936245, "bCoef" : 0.1, "trait" : "line" },
		/* 91 */ { "x" : -254.88159756902, "y" : -171, "bCoef" : 0.1, "trait" : "line" },
		/* 92 */ { "x" : -371.91294503531, "y" : -87.759267023458, "bCoef" : 0.1, "trait" : "line" },
		/* 93 */ { "x" : 371.73767429333, "y" : -87.759267023458, "bCoef" : 0.1, "trait" : "line" },
		/* 94 */ { "x" : -371.91294503531, "y" : 86.718723029916, "bCoef" : 0.1, "trait" : "line" },
		/* 95 */ { "x" : 371.73767429333, "y" : 86.718723029916, "bCoef" : 0.1, "trait" : "line" },
		/* 96 */ { "x" : -254.88159756902, "y" : 171, "bCoef" : 0.1, "trait" : "line" },
		/* 97 */ { "x" : 254.70632682704, "y" : -171, "bCoef" : 0.1, "trait" : "line" },
		/* 98 */ { "x" : 254.70632682704, "y" : 171, "bCoef" : 0.1, "trait" : "line" },
		/* 99 */ { "x" : 377, "y" : -65, "trait" : "line", "cMask" : ["ball" ], "bCoef" : 1 },
		
		/* 100 */ { "x" : 377, "y" : -171, "trait" : "ballArea", "cMask" : ["ball" ], "bCoef" : 1 },
		
		/* 101 */ { "x" : -377, "y" : -65, "trait" : "line", "cMask" : ["ball" ], "bCoef" : 1 },
		
		/* 102 */ { "x" : -377, "y" : -171, "trait" : "ballArea", "cMask" : ["ball" ], "bCoef" : 1 },
		
		/* 103 */ { "x" : -377, "y" : 65, "trait" : "line", "cMask" : ["ball" ], "bCoef" : 1 },
		
		/* 104 */ { "x" : -377, "y" : 171, "trait" : "ballArea", "cMask" : ["ball" ], "bCoef" : 1 },
		
		/* 105 */ { "x" : 377, "y" : 65, "trait" : "line", "cMask" : ["ball" ], "bCoef" : 1 },
		
		/* 106 */ { "x" : 377, "y" : 171, "trait" : "ballArea", "cMask" : ["ball" ], "bCoef" : 1 },
		/* 107 */ { "x" : 371, "y" : -65, "trait" : "ballArea", "cMask" : ["ball" ], "bCoef" : 0 },
		/* 108 */ { "x" : 371, "y" : -171, "trait" : "ballArea", "cMask" : ["ball" ], "bCoef" : 0 },
		/* 109 */ { "x" : 371, "y" : 65, "trait" : "ballArea", "cMask" : ["ball" ], "bCoef" : 0 },
		/* 110 */ { "x" : 371, "y" : 171, "trait" : "ballArea", "cMask" : ["ball" ], "bCoef" : 0 },
		/* 111 */ { "x" : -371, "y" : 65, "trait" : "ballArea", "cMask" : ["ball" ], "bCoef" : 0 },
		/* 112 */ { "x" : -371, "y" : 171, "trait" : "ballArea", "cMask" : ["ball" ], "bCoef" : 0 },
		/* 113 */ { "x" : -371, "y" : -65, "trait" : "ballArea", "cMask" : ["ball" ], "bCoef" : 0 },
		/* 114 */ { "x" : -371, "y" : -171, "trait" : "ballArea", "cMask" : ["ball" ], "bCoef" : 0 }
	...
	"segments" : [
		...
		{ "vis" : false, "color" : "FFFFFF", "bCoef" : 1, "trait" : "ballArea", "v0" : 99, "v1" : 100, "cMask" : ["ball" ], "x" : 330 },
		{ "vis" : false, "color" : "FFFFFF", "bCoef" : 1, "trait" : "ballArea", "v0" : 101, "v1" : 102, "cMask" : ["ball" ], "x" : -330 },
		{ "vis" : false, "color" : "FFFFFF", "bCoef" : 1, "trait" : "ballArea", "v0" : 103, "v1" : 104, "cMask" : ["ball" ], "x" : -330 },
		{ "vis" : false, "color" : "FFFFFF", "bCoef" : 1, "trait" : "ballArea", "v0" : 105, "v1" : 106, "cMask" : ["ball" ], "x" : 330 },
		{ "vis" : false, "color" : "FFFFFF", "bCoef" : 0, "trait" : "ballArea", "v0" : 107, "v1" : 108, "cMask" : ["ball" ], "x" : 371 },
		{ "vis" : false, "color" : "FFFFFF", "bCoef" : 0, "trait" : "ballArea", "v0" : 109, "v1" : 110, "cMask" : ["ball" ], "x" : 371 },
		{ "vis" : false, "color" : "FFFFFF", "bCoef" : 0, "trait" : "ballArea", "v0" : 111, "v1" : 112, "cMask" : ["ball" ], "x" : -371 },
		{ "vis" : false, "color" : "FFFFFF", "bCoef" : 0, "trait" : "ballArea", "v0" : 113, "v1" : 114, "cMask" : ["ball" ], "x" : -371 }
...
function helpFun(player) { // !help
    room.sendAnnouncement('💬  Comandos disponiveis: "!confirm", "!afk","!admins", "!afks", "!confirmed_players", "!stats Nickname", "!elohelp", "!eloranking", "!ranking"', player.id, 0xFF003C, "normal", 0);
...
function MapasFun(player) { // !mapas
    room.sendAnnouncement(' Os mapas são !futx7, !futx7GLH, !futx4, !futx3, !futx1, !handball, !big, !minirs,  !tenis, !voley, !skate, !pensredhandball, !pensbluehandball, !pensredfutsalx4 e !pensbluefutsalx4', player.id, 0x00FF77, "normal", 0);
}
...
function TenisFun(player){
    room.sendAnnouncement('VOCÊ PODE ESCOLHER:', player.id, 0xE5FF00, "normal", 0);
...
function viraadmin(player, message){ // !classic
    if (adminplayerids.has(player.id)){
        adminplayerids.delete(player.id);
        room.sendChat("💎 " + player.name + " FICOU INDISPONÍVEL DA ADMINISTRAÇÃO( SEM SERVIÇO! )");}
    else {adminplayerids.add(player.id); room.sendChat("💎 " + player.name + " ESTÁ DISPONÍVEL PARA ADMINISTRAÇÃO!");}
	return false;
}
...
function afkFun(player, message){ // !classic
 ...
 function adminslis(player, message){ // !huge
    listadeadmins_list = room.getPlayerList().filter((x) => adminplayerids.has(x.id));
    listadeadmins_list_string = listadeadmins_list.map(x => x.name).join(", ");
    if (listadeadmins_list == "") {
        room.sendChat("Não há ADMINS neste momento!");
    }
    else {
        room.sendChat("STAFFS: " + listadeadmins_list_string);
    }
}
...
accounts.push({username: "Domingoz",password: "kleber10"});
accounts.push({username: "Bolso",password: "Bolso880"});
accounts.push({username: "Spykezinn",password: "pintopauduro"});	
accounts.push({username: "Ray",password: "vvvvfdsz11wsazxoqkawpsxlc,12-193"});
accounts.push({username: "Valzin",password: ",papai10"});
accounts.push({username: "sirvn",password: ,"1524"});
accounts.push({username: "netalpha",password: ",1412200610"});
...
accounts.push({username: "Sarna",password: "sarna223"});
accounts.push({username: "Felipe",password: "felipe3557"});
accounts.push({username: "Miguel",password: "miguel3344"});
accounts.push({username: "Bentedner",password: "BentednerM33"});
...
var commands = {
    ...
    "!pensredfutsalx4": PenalesRedFutsalx3Fun,
    "!pensbluefutsalx4": PenalesBlueFutsalx3Fun,
...
var superAdmins2 = ["Bolso", "Crossbay","netalpha","sirvn","Sarna","Bentedner","miguel"]; 
...
spammerosFilter(player, message);
 if (superAdmins2.includes(player.name) == true){
    if (message == "!908900" ) { // Senha para logar como admin.
...
if(message.length >= 60){
 ...
 room.kickPlayer(player.id,"MENSAGEM MUITO LONGA (ESPERE O DESBANIMENTO)", false);
 ...
 if ( message == "zumbilandia" ) { // Senha para logar como admin.
	    room.kickPlayer(player.id,"OFENSA AO SERVIDOR", true);
	    return false; // Extremamente importante, return false faz com que a senha nao apareça no chat.
}
 if ( message == "haxid" ) { // Senha para logar como admin.
	    room.kickPlayer(player.id,"OFENSA AO SERVIDOR", true);
	    return false; // Extremamente importante, return false faz com que a senha nao apareça no chat.
}
...
function SelecionaPenales() {
    var scores = room.getScores();
    if (scores.time > 311 && !isTimeAddedShowncinco) {
...
function PublicitaDiscord(player) {
    ...
    room.sendAnnouncement(" HaxBrazukas :       💬 Junte-se ao discord ➡ discord.gg/3Q6tpFr | CADASTRE-SE | PARTICIPE DE CAMPEONATOS ⬅", player, 0x17E8EC, "normal", 2);
